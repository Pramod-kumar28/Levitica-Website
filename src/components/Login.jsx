...
const LoginPage = () => {
    return (
        <section className="hero-section hero-bg-2 tw-min-h-screen tw-flex tw-items-center lg:tw-pt-28">
            <div className="tw-max-w-7xl tw-mx-auto tw-px-4 lg:tw-py-4  tw-py-20 ">
                <div className="tw-grid lg:tw-grid-cols-2 tw-gap-12 tw-items-center">
                    ...
                    <div className="tw-bg-white tw-rounded-xl tw-shadow-xl tw-w-full tw-max-w-md tw-mx-auto  login-signup-card ">
                        <div className="lg:tw-px-8 lg:tw-py-10 tw-px-4 tw-py-6 ">
                            <div className="tw-mb-6">
                                <h2 className="tw-text-2xl tw-font-bold tw-my-1">Login</h2>
                        ...
                        {/* FOOTER */}
                        <div className="tw-border-t tw-px-4 lg:tw-px-8 tw-py-4 tw-text-sm">
