  ...
  return (
    <section className="tw-py-20 tw-bg-gradient-to-b tw-from-gray-50 tw-to-white">
      <div className="tw-max-w-7xl tw-mx-auto tw-px-4 sm:tw-px-6 lg:tw-px-8">
        ...
        {/* ================= VALUE HIGHLIGHTS ================= */}
        {/* <motion.div
          className="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 lg:tw-grid-cols-4 tw-gap-6 tw-mb-20"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <Highlight
            ...
            desc="Bank-level security protocols across all services"
            color="text-blue-600"
          />
          <Highlight
            icon={FaHandshake}
            title="Dedicated Support"
            desc="24/7 expert assistance and strategic guidance"
          ...
          <Highlight
            icon={FaSearch}
            title="Result-Driven"
            desc="Focus on measurable outcomes and ROI"
...
const Highlight = ({ icon: Icon, title, desc, color }) => (
  <motion.div
    className="tw-bg-white tw-rounded-2xl tw-p-6 tw-shadow-lg tw-border tw-border-gray-100 hover:tw-shadow-xl tw-transition-all"
    whileHover={{ y: -4 }}
  >
    <div className={`tw-inline-flex tw-items-center tw-justify-center tw-w-12 tw-h-12 tw-rounded-xl tw-bg-gradient-to-br tw-from-blue-50 tw-to-purple-50 tw-mb-4`}>
      <Icon size={24} className={color} />
    </div>
    <h4 className="tw-font-bold tw-text-gray-900">{title}</h4>
    <p className="tw-mt-2 tw-text-sm tw-text-gray-600">{desc}</p>
  </motion.div>
);

const Stat = ({ value, label, icon: Icon }) => (
  <div className="tw-text-center">
    <div className="tw-inline-flex tw-items-center tw-justify-center tw-w-16 tw-h-16 tw-rounded-2xl tw-bg-white tw-shadow-md tw-mb-4">
      <Icon size={24} className="tw-text-blue-600" />
    </div>
    <div className="tw-text-4xl tw-font-bold tw-text-gray-900 tw-mb-2">{value}</div>
    <div className="tw-text-sm tw-font-medium tw-text-gray-600">{label}</div>
  </div>
);
