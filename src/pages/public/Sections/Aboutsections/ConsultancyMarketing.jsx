    ...
    <section className="py-10 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div
            data-aos="fade-up"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm bg-orange-50 text-orange-600 mb-4 shadow-sm"
          >
          ...
          >
            Drive Growth with
            <span className="block my-2 bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
